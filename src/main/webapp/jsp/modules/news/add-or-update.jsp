    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑资源讲座</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">资源讲座管理</li>
                        <li class="breadcrumb-item active">编辑资源讲座</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">资源讲座信息</h3>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                newsName: "资源讲座名称不能为空",
                newsTypes: "资源讲座类型不能为空",
                newsPhoto: "资源讲座图片不能为空",
                insertTime: "资源讲座时间不能为空",
                newsContent: "资源讲座详情不能为空",
            }
        }).form();
    }
